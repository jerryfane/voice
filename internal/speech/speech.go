...
// Voice writes audio to a temp file, runs the template, and reads the result.
...
// Voice binary free of CGO and model weights.
package speech
...
type Transcriber interface {
	...
	// Name identifies the engine in logs and `voice doctor`.
	Name() string
